...
In my [previous blog post](using-ruby-in-aws-lambda.md) I described how you can run MRI Ruby on AWS Lambda. In this article I'll guide you through adding gems to the project: first [faker](https://github.com/stympy/faker), and then the [mysql2](https://github.com/brianmario/mysql2) gem with [activerecord](https://github.com/rails/rails/tree/master/activerecord), and finally we will have the Ruby code talk to an RDS instance, all this through an AWS Lambda.
